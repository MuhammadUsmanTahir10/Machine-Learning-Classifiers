# Making a Decision Tree Classifier for predicting the output based on the input training data
...
# Creating a Decision Tree Classifier for applying on our dataset
clf = tree.DecisionTreeClassifier()

# Training the decision Tree Classfier on our data set using fit method and updating it
